...
RUN_DIR = PROJECT_ROOT / "DSSAT_auto_validation" / "HLA_2004" / "run_CNHL0408_DSSAT480_2004"
...
def plot(daily: pd.DataFrame, events: pd.DataFrame) -> Path:
    ...
    daily_path = FIG_DIR / "hla0408_windows480_ic1_daily_rain_irrig_fert_stress.csv"
    events_path = FIG_DIR / "hla0408_windows480_ic1_management_events.csv"
    ...
    ax_stress.set_title("HLA 2004 IC=1 Windows DSSAT 4.8.0: rainfall, management events, and stress indices", fontsize=12)
    ...
    out = FIG_DIR / "hla0408_windows480_ic1_rain_irrig_fert_wspd_nstd.png"
...
def main() -> None:
    ...
    summary = {
        "figure": str(out),
        "daily_csv": str(FIG_DIR / "hla0408_windows480_ic1_daily_rain_irrig_fert_stress.csv"),
        "events_csv": str(FIG_DIR / "hla0408_windows480_ic1_management_events.csv"),
    ...
    pd.DataFrame([summary]).to_csv(FIG_DIR / "hla0408_windows480_ic1_plot_summary.csv", index=False, encoding="utf-8-sig")
