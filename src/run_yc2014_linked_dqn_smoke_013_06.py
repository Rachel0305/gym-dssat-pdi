...
OUT_DIR = PROJECT_ROOT / "DSSAT_auto_validation" / "multisite_new_cultivar_yc2014_linked_dqn_smoke_013_06"
DOC_PATH = PROJECT_ROOT / "docs" / "2026-06-30_013_06_yc2014_linked_dqn_smoke_record.md"
...
SCENARIO_ORDER = ["null", "recorded", "dssat_auto", "dqn_linked_free_daily", "dqn_linked_agronomic_window"]
SCENARIO_LABELS = {
    "null": "Null",
    "recorded": "Recorded",
...
def main() -> None:
    ...
    all_daily_df.to_csv(OUT_DIR / "013_06_yc2014_linked_dqn_smoke_daily.csv", index=False, encoding="utf-8-sig")
    summary_df.to_csv(OUT_DIR / "013_06_yc2014_linked_dqn_smoke_summary.csv", index=False, encoding="utf-8-sig")
    process_plot(all_daily_df, figures_dir / "yc2014_linked_dqn_smoke_process.png")
