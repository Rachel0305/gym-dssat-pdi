...
COMBOS = [
    {
        "name": "pen15_icost15_ns20_nlim300_nex5_ilim120_iex10",
        "penality": 15,
        "amir_cost": 15,
    ...
    {
        "name": "pen15_icost15_ns50_nlim250_nex10_ilim80_iex20",
        "penality": 15,
        "amir_cost": 15,
    ...
    {
        "name": "pen20_icost20_ns50_nlim220_nex15_ilim80_iex30",
        "penality": 20,
        "amir_cost": 20,
        "amir_no_stress_cost": 50,
...
def diagnose_combo(combo_dir: Path, args: argparse.Namespace) -> None:
...
def main() -> None:
    ...
    parser.add_argument("--output-dir", default="output_hl/rain_scaling_train/HL_scale0p6_penalty_scan_50k")
    ...
    for combo in COMBOS:
        ...
        diagnose_combo(combo_dir, args)
        done_marker.write_text("complete\n", encoding="utf-8")

    summary = summarize(output_dir)
    if not summary.empty:
        summary_path = output_dir / "penalty_scan_summary.csv"
