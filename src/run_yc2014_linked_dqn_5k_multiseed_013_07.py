...
OUT_DIR = PROJECT_ROOT / "DSSAT_auto_validation" / "multisite_new_cultivar_yc2014_linked_dqn_5k_multiseed_013_07"
DOC_PATH = PROJECT_ROOT / "docs" / "2026-06-30_013_07_yc2014_linked_dqn_5k_multiseed_record.md"
...
def write_doc(summary_df: pd.DataFrame) -> None:
    ...
    lines = [
        "# 013_07 YC2014 linked DQN 5K 多 seed 记录",
        "",
        "## 设置",
        "",
    ...
    seed_doc = OUT_DIR / f"seed{SEED}" / f"013_07_yc2014_linked_dqn_5k_seed{SEED}_record.md"
...
def main() -> None:
    ...
    all_daily_df.to_csv(run_out_dir / f"013_07_yc2014_linked_dqn_5k_seed{SEED}_daily.csv", index=False, encoding="utf-8-sig")
    summary_df.to_csv(run_out_dir / f"013_07_yc2014_linked_dqn_5k_seed{SEED}_summary.csv", index=False, encoding="utf-8-sig")
    process_plot(all_daily_df, figures_dir / f"yc2014_linked_dqn_5k_seed{SEED}_process.png")
