...
OUT_ROOT = ROOT / "DSSAT_auto_validation" / "HLA_2004" / "hla2010_nstep_dqn_seed1_020_06"
...
def main() -> None:
    ...
    run_dir = OUT_ROOT / f"nstep5_seed1_{args.timesteps}steps"
    if run_dir.exists():
    ...
    try:
        model = DQN(
            "MlpPolicy", train_env, verbose=0, seed=1,
    ...
    figure = run_dir / "figures" / f"hla2010_nstep5_seed1_{args.timesteps}steps.png"
    base.plot_checkpoints(daily, summary, figure, 2010, 1, args.timesteps)
