# SY 046_10 Seed-1 Stability Validation

## Objective

Test whether the frozen SYA originIC 16-action MaskablePPO result
`046_10_sya_originIC_expanded_action_maskableppo` can be reproduced with
`seed=1`. This is a stability validation, not a tuning experiment.

## One-factor contract

- Change only the random seed: `0 -> 1`.
- Keep the originIC input root and `SY/CNSY1201.MZX`, train years 2005--2013,
...
- Write only to `benchmark_results/069_00_sya_originIC_seed1_maskableppo_smoke2k`.
...
4. On any failure, stop SY immediately. On success, stop and wait for approval;
