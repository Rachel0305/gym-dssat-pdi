# 143E2 SYA engineered forecast MaskablePPO record

## Design

- Reference run: `142E2_sya_originIC_dual_branch_weather_reader_smoke2k`.
...
- Observation smoke audit: `benchmark_results/143E2_sya_originIC_dual_branch_weather_reader_5k/audits/143E2_forecast_observation_smoke.csv`.
- Forecast calendar audit: `benchmark_results/143E2_sya_originIC_dual_branch_weather_reader_5k/audits/143E2_forecast_calendar_audit.csv`.
- Output root: `benchmark_results/143E2_sya_originIC_dual_branch_weather_reader_5k`.
...
- `142E2_smoke_result_exists`: `True`
- `142E2_smoke_manifest_exists`: `True`
- `142E2_validation_exists`: `True`
- `142E2_status_completed`: `True`
- `142E2_smoke_gate_passed`: `True`
- `142E2_architecture_isolation_passed`: `True`
- `142E2_response_gate_passed`: `True`
- `142E2_five_k_candidate`: `True`
- `actions_match`: `True`
- `forecast_features_match`: `True`
- `input_station_seed_match`: `True`
- `next_step_allowed`: `True`
...
- `evaluation/143E2_training_checkpoint_inventory.csv` <- `evaluation/042_10_training_checkpoint_inventory.csv`
- `evaluation/143E2_checkpoint_validation_summary.csv` <- `evaluation/042_10_checkpoint_validation_summary.csv`
- `evaluation/143E2_validation_summary_by_station_checkpoint.csv` <- `evaluation/042_10_validation_summary_by_station_checkpoint.csv`
- `143E2_engine_result.json` <- `042_10_result.json`
