...
PROMPT = ROOT / "prompts" / "032_23_yc2018_75k_ppo_five_scenario_daily_figure.md"
OUT = ROOT / "benchmark_results" / "032_23_yc2018_75k_ppo_five_scenario_daily_figure"
FIG = OUT / "figures"
TAB = OUT / "tables"
SNAP = OUT / "snapshots"
DOC = ROOT / "docs" / "032_23_yc2018_75k_ppo_five_scenario_daily_figure_record.md"
...
SEED = 0
CHECKPOINT = 75_000
MODEL = ROOT / "benchmark_results" / "032_22_five_site_half_split_stress_aware_maskableppo_batch" / "models" / "YCA" / "YCA_half_split_stress_aware_maskableppo_seed0_ckpt75000.zip"

BASE35 = ROOT / "benchmark_results" / "031_35_missing_four_baseline_completion_for_03134" / "snapshots" / "YCA" / "2018"
AUTO36 = ROOT / "benchmark_results" / "031_36_missing_dssat_auto_completion_for_03134" / "snapshots" / "YCA" / "2018" / "dssat_auto"
PPO_SNAPSHOT = SNAP / "YCA" / "2018" / "rl_candidate_seed0_ckpt75000"
...
def run_ppo_and_save_snapshot() -> pd.DataFrame:
    ...
    env = base.make_env(config, env_config, STATION, YEAR, SEED, "YCA_2018_032_23_seed0_ckpt75000_eval", evaluation=True)
...
def main() -> None:
    ...
    eval_trace.to_csv(TAB / "032_23_yc2018_ppo_eval_trace.csv", index=False, encoding="utf-8-sig")
    ...
    if not bool(checks_df["required_complete"].all()):
        checks_df.to_csv(TAB / "032_23_snapshot_checks.csv", index=False, encoding="utf-8-sig")
        raise RuntimeError("snapshot checks failed; see 032_23_snapshot_checks.csv")
    ...
    case = Case(
        ...
        note="032_22 YC half-split stress-aware free-timing MaskablePPO seed0 checkpoint 75k; snapshot regenerated by frozen deterministic evaluation.",
    )
    ...
    daily_path = TAB / "032_23_yc2018_75k_ppo_five_scenario_daily.csv"
    summary_path = TAB / "032_23_yc2018_75k_ppo_five_scenario_summary.csv"
    checks_path = TAB / "032_23_yc2018_75k_ppo_daily_evidence_checks.csv"
    snapshot_checks_path = TAB / "032_23_snapshot_checks.csv"
    ...
    result = {
        "task": "032_23_yc2018_75k_ppo_five_scenario_daily_figure",
    ...
    (OUT / "032_23_result.json").write_text(json.dumps(result, indent=2, ensure_ascii=False), encoding="utf-8")
