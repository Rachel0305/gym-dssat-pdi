# 054 HLA lowIC site-transfer PPO and baseline workflow

## Purpose

Move the controlled SYA lowIC workflow to HLA without changing the PPO method.
This task is a site-transfer experiment, not a new PPO-method experiment.

## Fixed Method Contract

- Station: HLA / site HLA.
- Input profile: lowIC, using `DSSAT_auto_validation/multisite_new_cultivar_inputs_013`.
...
- New outputs must live under 054-named folders.
